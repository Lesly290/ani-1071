...
c1-exo3_main.cpp:6:9: error: expected ';' after return statement
    6 | return 0
      |         ^
      |         ;
3 errors generated.
...
Afin de mieux expliquer le 2ème volet de cette question, nous avons remplacé la commande printf par Printf . Et les erreurs suivantes ont été affichés :
 ...
 | ^~~~~~
      | printf
C:/msys64C/ucrt64/include/stdio.h:300:5: note: 'printf' declared here
...
*       ANALYSONS LA TROISIEME ERREUR
  Le but du 3ème volet de ce devoir consiste à retirer la ligne   #include <cstdio> . De ce fait , nous avons analysé les erreurs qui suivent :
 printf("LESLY CHEBOU\n");
      | ^~~~~~
c1-exo3_main.cpp:5:1: error: use of undeclared identifier 'printf'
    5 | printf("YAOUNDE\n");
      | ^~~~~~
    2 errors generated.
De ce fait, nous pouvons bien voir qu'en exécutant le programme tout en retirant la ligne comportant #include <cstdio> , nous retrouvons les erreurs consignées ci déçu.
 ...
 Nous voyons bien que le fait de compiler ce programme sans l'insertion de la ligne #include <cstdio> nous renvoi sur ses lignes çi déçu .
